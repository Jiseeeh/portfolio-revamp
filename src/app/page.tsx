...
export default function Home() {
  return (
    ...
    >
      ...
      <div className="flex flex-col p-4 space-y-4 lg:w-11/12 lg:justify-center handle-max-w">
        <h5 className="text-xl font-black lg:text-4xl">About me</h5>
        ...
        <button className="flex px-4 py-3 font-bold text-xl bg-teal transition-colors duration-200 hover:bg-[#009199] self-start gap-3 rounded-md items-center">
          <Link href="/CAMARA-JOHN_CARLO-N-RESUME-2024.pdf" target="_">
            Resume
          </Link>{" "}
          <FaExternalLinkAlt />
        </button>
